...
(function() {
  ...
  var TreeNode1 = function(text, offset, elements) {
    ...
    this['grammar'] = elements[1];
  };
  inherit(TreeNode1, TreeNode);

  var TreeNode2 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['grammar'] = elements[2];
  };
  inherit(TreeNode2, TreeNode);

  var TreeNode3 = function(text, offset, elements) {
    TreeNode.apply(this, arguments);
    this['grammar_name'] = elements[0];
  };
  ...
  var Grammar = {
    _read_concat_grammar: function() {
      var address0 = FAILURE, index0 = this._offset;
      this._cache._concat_grammar = this._cache._concat_grammar || {};
      var cached = this._cache._concat_grammar[index0];
      if (cached) {
      ...
      if (elements0 === null) {
        ...
        address0 = this._actions.multi_grammar(this._input, index1, this._offset, elements0);
        this._offset = this._offset;
      }
      this._cache._concat_grammar[index0] = [address0, this._offset];
      return address0;
    },
    ...
    _read_grammar: function() {
      ...
      var index1 = this._offset, elements0 = new Array(3);
      var address1 = FAILURE;
      address1 = this._read_grammar_name();
      if (address1 !== FAILURE) {
        elements0[0] = address1;
  ...
  Parser.prototype.parse = function() {
    var tree = this._read_concat_grammar();
